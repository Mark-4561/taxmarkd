...
#
#
# def line_detective(img, gray_img):
...
#
#         if (i == 0):
#             cutg = gray[list_frame[i * 2][1]: list_frame[i * 2 + 1][1], list_frame[i * 2][0]: list_frame[i * 2 + 1][0]]
#             lines = text_detective(cutg)
